<?php
    ...
    $id = $_GET['ID_Ruang'];
    $rng = mysqli_query($koneksi, "SELECT * FROM ruangan WHERE ID_Ruang='$id'");
    $ruang = mysqli_fetch_assoc($rng);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- form ruangan -->
                ...
                <form action="" method="POST" name="form-input-data">
                    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="46">
                            ...
                            <td><input type="text" name="id_ruang" size="50" maxlength="6" style="padding-left:3px ; height: 20px;" id="ruang" value="<?php 
                                echo $ruang['ID_Ruang'] ?>"readonly></td>
                        </tr>
                        <tr height="46">
                            <td> </td>
                            <td>Nama Ruang</td>
                            <td><input type="text" name="nama_ruang" size="50" maxlength="30" style="padding-left:3px ; height: 20px; " value="<?php 
                                echo $ruang['Nama_Ruang'] ?>"></td>
                        </tr>
                        <tr height="46">
                            <td> </td>
                            <td>Nama Gedung</td>
                            <td><input type="text" name="nama_gedung" size="50" maxlength="12" style="padding-left:3px ; height: 20px;" value="<?php 
                                echo $ruang['Nama_Gedung'] ?>"></td>
                        </tr>
                        <tr height="46">
                            <td> </td>
                            <td> </td>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $Ruang = mysqli_query($koneksi, "UPDATE ruangan SET Nama_Ruang='$nama', Nama_Gedung ='$nama_gdng' WHERE ID_Ruang='$id'");
