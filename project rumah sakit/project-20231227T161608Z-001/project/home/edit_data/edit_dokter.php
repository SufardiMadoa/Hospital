<?php
    ...
    $id = $_GET['ID_Dokter'];
    $Dr = mysqli_query($koneksi, "SELECT * FROM dokter WHERE ID_Dokter='$id'");
    $Dokter = mysqli_fetch_assoc($Dr);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="body">
                ...
                <form action="" method="POST" name="form-input-data">
                    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="46">
                            <td> </td>
                            <td>ID Dokter</td>
                            <td><input type="text" name="id_dokter" size="50" maxlength="30" value="<?php 
                                echo $Dokter['ID_Dokter'] ?>"readonly></td>
                        </tr>
                        <tr height="46">
                            <td> </td>
                            <td>Nama</td>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $alamat= $_POST['alamat'];
            $poli= $_POST['poli'];
            $Ruang = mysqli_query($koneksi, "UPDATE dokter SET Nama='$nama', Alamat ='$alamat',
            Poli='$poli' WHERE ID_Dokter='$id'");
