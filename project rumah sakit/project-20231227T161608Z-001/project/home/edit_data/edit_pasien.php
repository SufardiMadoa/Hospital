<?php
    ...
    $id = $_GET['ID_Pasien'];
    $psien = mysqli_query($koneksi, "SELECT * FROM pasien WHERE ID_Pasien='$id'");
    $pasien = mysqli_fetch_assoc($psien);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="body">
        ...
        <form action="" method="POST" name="form-input-data">
            <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr height="46">
                    <td> </td>
                    <td>ID Pasien</td>
                    <td><input type="text" name="id_pasien" size="50" maxlength="6" value="<?php 
                                echo $pasien['ID_Pasien'] ?>"readonly></td>
                </tr>
                <tr height="46">
                    <td> </td>
                    <td>ID Dokter</td>
                    <td><input type="text" name="id_dokter" size="50" maxlength="6" value="<?php 
                                echo $pasien['ID_Dokter'] ?>"></td>
                </tr>
                <tr height="46">
                    <td> </td>
                    <td>Nama</td>
                ...
                <tr height="46">
                    <td> </td>
                    <td>Alamat</td>
                    <td><input type="text" name="alamat" size="50" maxlength="12" value="<?php 
                                echo $pasien['Alamat'] ?>"></td>
                </tr>
                <tr height="46">
                    <td> </td>
                    <td>Tanggal Datang </td>
                    <td><input type="date" name="tgl_datang" size="20" maxlength="12" value="<?php 
                                echo $pasien['Tgl'] ?>"></td>
                </tr>
                <tr height="46">
                    <td> </td>
                    <td>Keluhan</td>
                    <td><input type="text" name="keluhan" size="50" maxlength="30" value="<?php 
                                echo $pasien['Keluhan'] ?>"></td>
                </tr>
                <tr height="46">
                    <td> </td>
                    <td> </td>
    ...
    <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            $pasien = mysqli_query($koneksi, "UPDATE pasien SET ID_Dokter='$id_Dr', Nama ='$nama',
            Alamat='$alamat',Tgl='$tgl',Keluhan='$keluhan' WHERE ID_Pasien='$id'");
