...
<?php
    ...
    $ptgs = mysqli_query($koneksi, "SELECT * FROM petugas");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- form ruangan -->
                ...
                <form action="" method="POST" name="form-input-data">
                    <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="46">
                            <td> </td>
                            <td>ID Petugas</td>
                            <td><input type="text" name="id_petugas" size="50" maxlength="6" /></td>
                        </tr>
                        <tr height="46">
                            <td> </td>
                            <td>Nama</td>
                        ...
                        <tr height="46">
                            <td> </td>
                            <td>No_Telepon</td>
                            <td><input type="text" name="no_tlp" size="50" maxlength="12" /></td>
                        </tr>
                        <tr height="46">
                            <td> </td>
                            <td> </td>
    ...
    $alamat= $_POST['alamat'];
    $hp=$_POST['no_tlp'];
    $petugas = mysqli_query($koneksi, "INSERT INTO petugas(ID_petugas, Nama, Alamat, No_tlp)VALUES('$id', '$nama', '$alamat', '$hp')");
