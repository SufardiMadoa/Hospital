        ...
        <form action="" method="post">
            <table>
                <tr>
                    ...
                    echo $dataMahasiswa['nim'] ?>" readonly>
                    </td>
                </tr>
                <tr>
                    <td>Nama</td>
                ...
                <tr>
                    ...
                    echo $dataMahasiswa['email']?>">
                    </td>
                </tr>
                <tr>
                    <td>hp</td>
                    <td>:</td>
                    <td><input type="text" name="hp" value="<?php 
                    echo $dataMahasiswa['hp']?>">
                    </td>
                </tr>
                <tr>
                    <td>Prodi</td>
